    ...
    <main className="h-screen mt-[4rem]">
      ...
      <section className="mt-2 px-4">
        ...
        <div className=" flex flex-col gap-y-2  rounded-md  outline-1 px-2 py-4 *:text-lg *:py-1 ">
          ...
          <p className='unit_text '>- Découvrir des vocations nouvelle</p>
          <p className='unit_text '>- Découvrir les productions écrites de belles factures</p>
          <p className='unit_text '>- Mettre en scène ces productions</p>
          <p className='unit_text '>- Permettre aux apprenants, inscrits d'affiner et de confronter leurs pratiques rédactionnelles et leurs vocations artistiques</p>
          <p className='unit_text '>- Apprendre à travailler en équipe</p>
          <p className='unit_text '>- Publier la revue trimestrielle de l'étudiant "ecosig"</p>
          <p className='unit_text '>- Apprendre à travailler en réseau avec les ateliers "écriture" "théâtre" de la FST, FLSH</p>
          <p className='unit_text '>- Participer à des concours de la belle plume(nouvelle, pièce de théâtre, poème)</p>
          <p className='unit_text '>- Former Eventuellement de Futurs animateurs et enfin se préparer aux grands festivals</p>
        </div>
        ...
        <NavLink 
            className="bg-blue-600 active:text-red-600 active:scale-105 transition-all duration-300 ease-in-out
            text-neutral-100 mt-4 mb-6 w-full flex flex-col items-center *:flex *:gap-2  py-2 rounded-md text-2xl outline-0 border-0 
            " 
            to={`/inscription`}>
