const Quote = () => {
    return (
        <div className="px-4 relative">
            <h1 className="text-3xl my-4 font-semibold text-center md:text-4xl ">Mot du directeur</h1>
            <div className="md:grid grid-cols-2 gap-4 md:bg-neutral-900 md:rounded-2xl md:text-neutral-50 md:p-4  md:relative">
                ...
                <h1 className="text-2xl my-1 px-1 border-l-4 rounded-sm border-red-500 md:text-5xl md:border-l-6 ">Une Ecole en Evolution Permanente</h1>
                ...
                <p className="text-sm capitalize hidden md:block md:text-3xl textgit-700 font-light  absolute bottom-4 right-4 tracking-wider">M. moustahfid abderrahmane</p>
            </div>
        </div>
    )
}
