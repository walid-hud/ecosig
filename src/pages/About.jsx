...
const Objectifs = () => (
  <>
    ...
    '>
      <div
        id='card'
        className='transition-hover-effect my-2 flex flex-col border-2 border-neutral-800 rounded-lg h-[22rem] overflow-hidden backdrop-blur-lg lg:h-[24rem]'
      >
      ...
      <div
        id='card'
        className='md:hidden transition-hover-effect my-2 flex flex-col border-2 border-neutral-800 rounded-lg h-[22rem] overflow-hidden backdrop-blur-lg lg:h-[24rem]'
      >
      ...
      <section className='mt-2 px-4 h-fit'>
        ...
        <div className='flex w-full'>
          <div className='lg:w-1/2'>
            <p className='text_reveal lg:text_reveal-none text-lg lg:text-xl ' style={{ animationRangeStart: "cover calc(100vh - 14rem)  ", animationRangeEnd: 'contain calc(100vh)' }}>
